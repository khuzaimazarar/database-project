...
<body>
  ...
  <div class="main-div">
    <div class="category-card">
      ...
      <div class="category-label">pepperoni pizza</div>
      <div class="category-label2">1200</div>
    </div>
    <div class="category-card">
      <img src="Pizza Margarita.jpg" alt="Burger">
      <div class="category-label">Pizza Margarita</div>
      <div class="category-label2">1300</div>
    </div>
    <div class="category-card">
      <img src="Barbeque Chicken Pizza.jpg" alt="Drinks">
      <div class="category-label">Barbeque Chicken Pizza</div>
      <div class="category-label2">1600</div>
    </div>
    <div class="category-card">
      <img src="Veggie Pizza.jpg" alt="Pastas">
      <div class="category-label">Veggie Pizza</div>
      <div class="category-label2">1550</div>
    </div>
    <div class="category-card">
      <img src="Craving Chicken Pizza.jpg" alt="Dessert">
      <div class="category-label">Craving Chicken Pizza</div>
      <div class="category-label2">1650</div>
    </div>
    <div class="category-card">
      <img src="Meat Pizza.jpg" alt="Appetizers">
      <div class="category-label">Chicken Alfredo Pizza</div>
      <div class="category-label2">1900</div>
    </div>
    <div class="category-card">
      <img src="Hawaiaan Pizza.jpg" alt="Vegetarian">
      <div class="category-label">Meat Pizza</div>
      <div class="category-label2">2100</div>
    </div>
    <div class="category-card">
      <img src="Four Cheese Pizza.jpg" alt="Salad">
      <div class="category-label">Four Cheese Pizza</div>
      <div class="category-label2">2500</div>
    </div>
