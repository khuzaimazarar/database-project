...
  <h1 class="category-title">Choose Your Desserts</h1>   <div class="main-div">

        <div class="category-card" data-desc="Rich and moist chocolate cake slices.">
      <div class="description"></div>       <img src="br.jpg" alt="Chocolate Cake">       <div class="category-label">Chocolate Cake</div>       <div class="category-label2">800</div>     </div>


    <div class="category-card" data-desc="Creamy and classic cheesecake with various toppings.">
      <div class="description"></div>
      <img src="Ice Cream Trio.jpg" alt="Cheesecake">       <div class="category-label">Cheesecake</div>
      <div class="category-label2">950</div>
    </div>

    <div class="category-card" data-desc="Delicious assorted pastries, baked fresh daily.">
      <div class="description"></div>
      <img src="ps.jpeg" alt="Assorted Pastries">       <div class="category-label">Assorted Pastries</div>
      <div class="category-label2">600</div>
    </div>

    <div class="category-card" data-desc="Coffee-flavored Italian dessert with ladyfingers and mascarpone.">
      <div class="description"></div>
      <img src="tiramisu.jpg" alt="Tiramisu">       <div class="category-label">Tiramisu</div>
      <div class="category-label2">750</div>
    </div>

    <div class="category-card" data-desc="Warm, fudgy chocolate brownies.">
      <div class="description"></div>
      <img src="th.jpeg" alt="Chocolate Brownie">       <div class="category-label">Chocolate Brownie</div>
      <div class="category-label2">400</div>
    </div>

    <div class="category-card" data-desc="Scoops of your favorite ice cream flavors.">
      <div class="description"></div>
      <img src="br.jpg" alt="Ice Cream">       <div class="category-label">Ice Cream</div>
